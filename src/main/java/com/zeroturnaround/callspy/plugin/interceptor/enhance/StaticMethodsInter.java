...
public class StaticMethodsInter {
    ...
    public Object intercept(@Origin Class<?> clazz, @AllArguments Object[] allArguments, @Origin Method method,
        ...
        try {
            ...
            System.out.println(String.format( "class[{}] before static method[{}] intercept failure", clazz, method.getName()));
        }
        ...
        try {
            ...
            try {
                ...
                System.out.println(String.format("class[{}] handle static method[{}] exception failure", clazz, method.getName(), t2.getMessage()));
            }
            throw t;
        } finally {
            try {
                ...
                System.out.println(String.format("class[{}] after static method[{}] intercept failure:{}", clazz, method.getName(), t.getMessage()));
            }
        }
        return ret;
    }
